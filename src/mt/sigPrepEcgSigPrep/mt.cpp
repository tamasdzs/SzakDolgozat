...
#define MT_MIT_BIH_MEASUREMENT_NAME_2_STR "105"

#define MT_NUM_OF_LEADS_INT 2

#define MT_NUM_OF_SAMPLES_1_INT 600
#define MT_NUM_OF_SAMPLES_2_INT 300 

#define MT_SAMPLE_DILATATION_DOUBLE  (double)0.5
#define MT_SAMPLE_TRANSLATION_DOUBLE (double)8.7
