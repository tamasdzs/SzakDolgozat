...
\item A \texttt{compression\_normal.php} által generált weboldalon egy testzőleges jel kiválasztása és tömörítése. Annak ellenőrzése, hogy az interfész a \texttt{compression\_loading.php} script által generált weboldalra irányítja a bömgészőt.
